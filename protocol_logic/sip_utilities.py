...
class SIPRegistrar:
    def __init__(self, ip,  port):
        ...
        self.register_ok_msg = ''.join(['SIP/2.0 200 OK\r\n',
                'Via: [VIA]\r\n',
                'From: [FROM]\r\n',
		'To: [TO];tag=2f3f4a-1331821416660146\r\n',
                'Call-ID: [CALL-ID]\r\n',
    ...
    def waitForRegister(self):
        ...
        while 1:
            data, incoming_addr = self.sock.recvfrom(1024)
	    self.client_port = incoming_addr[1]
            self.log('Got client port number ' + str(self.client_port))
